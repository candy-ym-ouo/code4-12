...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/substitutions/new", component: () => import("@/pages/SubstitutionFormPage.vue") },
    { path: "/substitutions/rules", component: () => import("@/pages/SubstitutionRulesPage.vue") },
    { path: "/substitutions/:id", component: () => import("@/pages/SubstitutionDetailPage.vue") },
